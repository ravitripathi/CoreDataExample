...
class CoreDataTableViewController: UITableViewController {
    ...
    func setDBObserver() {
        ...
        notificationCenter.addObserver(self, selector: #selector(didChangeDB), name: NSNotification.Name.NSManagedObjectContextObjectsDidChange, object: managedContext)
    }
    
    @objc func didChangeDB() {
        self.modelList = CoreDataManager.getAllData()
